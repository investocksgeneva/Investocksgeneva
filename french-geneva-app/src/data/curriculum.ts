...
export const week1: Week = {
  ...
  vocab: [
    ...
    { fr: "s'appeler", en: 'to be named / called' },
  ],
}
...
export const week2: Week = {
  ...
  vocab: [
    ...
    { fr: 'un chauffeur', en: 'a driver' },
    { fr: 'un plan', en: 'a map' },
    { fr: 'un abonnement', en: 'a pass / subscription' },
    { fr: 'valable', en: 'valid' },
    { fr: 'une voie', en: 'a track / platform lane' },
    { fr: 'un vélo', en: 'a bike' },
    { fr: 'rouler', en: 'to drive / ride' },
    { fr: 'un contrôleur', en: 'a ticket inspector' },
...
export const week3: Week = {
  ...
  vocab: [
    ...
    { fr: 'un supermarché', en: 'a supermarket' },
    { fr: 'la caisse', en: 'the checkout' },
    { fr: 'un sac', en: 'a bag' },
    { fr: 'frais / fraîche', en: 'fresh' },
    { fr: 'une portion', en: 'a portion' },
    { fr: 'le menu', en: 'the fixed/set menu' },
    { fr: 'une boisson', en: 'a drink' },
    { fr: "l'eau", en: 'water' },
    { fr: 'sucré', en: 'sweet' },
  ],
}
...
export const week4: Week = {
  ...
  vocab: [
    ...
    { fr: 'content(e)', en: 'happy / glad' },
    { fr: 'fatigué(e)', en: 'tired' },
    { fr: 'occupé(e)', en: 'busy' },
    { fr: 'un ami / une amie', en: 'a friend' },
    { fr: 'sympa', en: 'nice / friendly' },
    { fr: 'marrant', en: 'funny' },
    { fr: 'bizarre', en: 'weird / strange' },
...
export const week5: Week = {
  ...
  vocab: [
    ...
    { fr: 'un rhume', en: 'a cold (illness)' },
    { fr: 'une allergie', en: 'an allergy' },
    { fr: 'vomir', en: 'to vomit' },
    { fr: 'la santé', en: 'health' },
    { fr: 'un vaccin', en: 'a vaccine' },
    { fr: 'une piqûre', en: 'a shot / injection' },
    { fr: 'enceinte', en: 'pregnant' },
    { fr: 'les urgences', en: 'the emergency room' },
    { fr: 'un pansement', en: 'a bandage' },
    { fr: 'des vertiges', en: 'dizziness' },
  ],
}
...
export const week6: Week = {
  ...
  vocab: [
    ...
    { fr: 'un immeuble', en: 'a building' },
    { fr: 'un ascenseur', en: 'an elevator' },
    { fr: 'le sous-sol', en: 'the basement' },
    { fr: 'un bail', en: 'a lease' },
    { fr: 'la caution', en: 'the deposit' },
    { fr: 'un voisin / une voisine', en: 'a neighbor' },
    { fr: 'déménager', en: 'to move (house)' },
    { fr: 'emménager', en: 'to move in' },
    { fr: 'les clés', en: 'the keys' },
    { fr: 'un état des lieux', en: 'a move-in/move-out inspection' },
  ],
}
...
export const week7: Week = {
  ...
  vocab: [
    ...
    { fr: "retirer de l'argent", en: 'to withdraw money' },
    { fr: 'un distributeur', en: 'an ATM' },
    { fr: 'un code', en: 'a PIN / code' },
    { fr: 'un reçu', en: 'a receipt' },
    { fr: 'un chèque', en: 'a check' },
    { fr: 'une boîte aux lettres', en: 'a mailbox' },
    { fr: 'recommandé', en: 'registered (mail)' },
    { fr: "l'expéditeur", en: 'the sender' },
    { fr: 'le destinataire', en: 'the recipient' },
  ],
}
...
export const week8: Week = {
  ...
  vocab: [
    ...
    { fr: 'un vol', en: 'a theft' },
    { fr: 'voler', en: 'to steal' },
    { fr: 'un témoin', en: 'a witness' },
    { fr: 'crier', en: 'to shout' },
    { fr: 'prévenir', en: 'to warn / notify' },
    { fr: 'un danger', en: 'a danger' },
    { fr: 'secourir', en: 'to rescue' },
    { fr: 'calme', en: 'calm' },
  ],
}
...
export const week9: Week = {
  ...
  vocab: [
    ...
    { fr: 'un employé / une employée', en: 'an employee' },
    { fr: 'un patron / une patronne', en: 'a boss' },
    { fr: 'un salaire', en: 'a salary' },
    { fr: 'un contrat de travail', en: 'an employment contract' },
    { fr: 'une pause déjeuner', en: 'a lunch break' },
    { fr: 'un ordinateur', en: 'a computer' },
    { fr: 'un e-mail', en: 'an email' },
    { fr: 'un client', en: 'a client' },
    { fr: 'une présentation', en: 'a presentation' },
    { fr: 'une formation', en: 'a training' },
  ],
}
...
export const week10: Week = {
  ...
  vocab: [
    ...
    { fr: 'un grand-père', en: 'a grandfather' },
    { fr: 'une grand-mère', en: 'a grandmother' },
    { fr: 'un cousin / une cousine', en: 'a cousin' },
    { fr: 'un neveu / une nièce', en: 'a nephew / niece' },
    { fr: 'un bébé', en: 'a baby' },
    { fr: 'élever', en: 'to raise (children)' },
